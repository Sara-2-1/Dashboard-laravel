                                ...
                                <div class="col-auto col-md-5 col-xl-4 px-sm-4 px-0 bg-dark">
                                    <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                                        ...
                                        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                                            <li class="nav-item">
                                                <a href="{{route('cntrolpanel')}}" class="nav-link align-middle px-0">
                                            ...
                                            <li>
                                                <a href="{{route('additem')}}" class= "nav-link align-middle px-0" >
                                                    <i class="bi bi-bag-plus-fill"></i> <span class="ms-1 d-none d-sm-inline text-white">اضافة عنصر </span></a>
                                            </li>
                                            <li>
                                                <a href="{{route('bills')}}" class="nav-link px-0 align-middle ">
                                                    <i class="bi bi-receipt"></i> <span class="ms-1 d-none d-sm-inline text-white"> فواتير </span></a>            
                                        ...
                                        <div class="dropdown pb-4">
                                            <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                                                <span class="d-none d-sm-inline mx-1">Sarah</span>
                                            </a>
